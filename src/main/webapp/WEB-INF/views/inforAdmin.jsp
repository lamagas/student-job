...
<div class="Navigation">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
            <li class="layui-nav-item"><a href="/admin">主页</a></li>
            <li class="layui-nav-item">
                <a href="javascript:;">信息管理</a>
                <dl class="layui-nav-child">
                    <dd><a href="javascript:;" class="infortab" data-url="write" mytitle="发布兼职" iid="0">发布兼职</a></dd>
                    <dd><a href="javascript:;" class="infortab" data-url="draft" mytitle="草稿" iid="-1">草稿</a></dd>
                    <dd><a href="javascript:;" class="infortab" data-url="recycle" mytitle="回收站" iid="-3">回收站</a></dd>
                </dl>
            </li>
        ...
        <ul class="layui-nav layui-layout-right"style="right: 38px">
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd><a class="infortab" data-url="person" mytitle="基本资料" iid="-2" href="javascript:;">基本资料</a></dd>
                    <dd><a href="">安全设置</a></dd>
                </dl>
            </li>
...
<%--                <table class="layui-table" lay-size="lg">
                    ...
                    <c:forEach varStatus="s" items="${informations}" var="item" >
                        <tr class="layui-nav-item infortab" data-url="messAdmin?id=${item.inforid}" mytitle="${item.title} " iid="${item.inforid}"
...
<script>
    ...
    layui.use(['element','table'], function() {
        ...
        //触发事件
        var active = {
            tabAdd: function (m,u,i) {
                //新增一个Tab项
                element.tabAdd('demo', {
                    title:m
                    ,content: '<iframe style="width: 100%;height: 100%" scrolling="yes" src='+u+' ></iframe>'
                    ,id: i
                })
        ...
        table.on('tool(get)', function(obj){
            var data = obj.data;
            tabAdd(data.title,'messAdmin?id='+data.titleId,data.titleId);
        });
    });
